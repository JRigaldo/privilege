			...
			'front' => array(
				...
				'post_content' => join(
					...
					array(
						...
						'<p></p>',
						'<!-- /wp:paragraph -->',
						'<!-- wp:group {"customBackgroundColor":"$lightfff","align":"wide"} -->',
						'<div class="wp-block-group alignwide has-background" style="background-color:$lightfff"><div class="wp-block-group__inner-container"><!-- wp:group -->',
